      ...
      <ScrollView>
        ...
        <View style={styles.checkboxContainer} >
          <CheckBox value={physics}
            onValueChange={setPhysics}/>
          <Text style={
            {...styles.checkBoxTxt,
              color:physics?"#fc5185":"gray",
              fontWeight:physics? "bold" :"normal"
            }
          }
          >Physics</Text>
          ...
          <Text style={
            {...styles.checkBoxTxt,
            color:chemistry?"#fc5185":"gray",
            fontWeight:chemistry? "bold" :"normal"
            }
          }
          >Chemistry</Text>
          <CheckBox value={biology}
          onValueChange={setBiology}/>
          <Text style={
            {...styles.checkBoxTxt,
            color:biology?"#fc5185":"gray",
            fontWeight:biology? "bold" :"normal"
            }
          }
          >Biology</Text>
          <CheckBox value={math}
          onValueChange={setMath}/>
          <Text style={
            {...styles.checkBoxTxt,
            color:math?"#fc5185":"gray",
            fontWeight:math? "bold" :"normal"
            }
          }
          >Mathematics</Text>
          ...
          <Text style={
            {...styles.checkBoxTxt,
            color:english?"#fc5185":"gray",
            fontWeight:english? "bold" :"normal"
            }
          }
          >English</Text>
        </View> 
